 ...
 */
final class Version20220801125640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media ADD post VARCHAR(255) DEFAULT NULL, DROP post_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE media ADD post_id INT DEFAULT NULL, DROP post');
